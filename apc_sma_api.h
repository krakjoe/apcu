...
*/
extern PHP_APCU_API void apc_sma_api_init(apc_sma_t* sma,
                             void** data,
...
*/
extern PHP_APCU_API void apc_sma_api_cleanup(apc_sma_t* sma TSRMLS_DC);

/*
* apc_smap_api_malloc will allocate a block from the sma of the given size
*/
extern PHP_APCU_API void* apc_sma_api_malloc(apc_sma_t* sma, 
                                zend_ulong size TSRMLS_DC);

/*
* apc_sma_api_malloc_ex will allocate a block from the sma of the given size
*/
extern PHP_APCU_API void* apc_sma_api_malloc_ex(apc_sma_t* sma, 
                                   zend_ulong size, 
                                   zend_ulong fragment, 
...
*/
extern PHP_APCU_API void* apc_sma_api_realloc(apc_sma_t* sma, 
                                 void* p, 
                                 zend_ulong size TSRMLS_DC);
...
#define apc_sma_api_decl(name) \
    extern PHP_APCU_API void apc_sma_api_func(name, init)(zend_uint num, zend_ulong size, char* mask TSRMLS_DC); \
    extern PHP_APCU_API void apc_sma_api_func(name, cleanup)(TSRMLS_D); \
    extern PHP_APCU_API void* apc_sma_api_func(name, malloc)(zend_ulong size TSRMLS_DC); \
    extern PHP_APCU_API void* apc_sma_api_func(name, malloc_ex)(zend_ulong size, zend_ulong fragment, zend_ulong* allocated TSRMLS_DC); \
    extern PHP_APCU_API void* apc_sma_api_func(name, realloc)(void* p, zend_ulong size TSRMLS_DC); \
    extern PHP_APCU_API char* apc_sma_api_func(name, strdup)(const char* s TSRMLS_DC); \
    extern PHP_APCU_API void apc_sma_api_func(name, free)(void* p TSRMLS_DC); \
    extern PHP_APCU_API void* apc_sma_api_func(name, protect)(void* p); \
    extern PHP_APCU_API void* apc_sma_api_func(name, unprotect)(void* p); \
    extern PHP_APCU_API apc_sma_info_t* apc_sma_api_func(name, info)(zend_bool limited TSRMLS_DC); \
    extern PHP_APCU_API void apc_sma_api_func(name, free_info)(apc_sma_info_t* info TSRMLS_DC); \
    extern PHP_APCU_API zend_ulong apc_sma_api_func(name, get_avail_mem)(); \
    extern PHP_APCU_API zend_bool apc_sma_api_func(name, get_avail_size)(zend_ulong size); \
    extern PHP_APCU_API void apc_sma_api_func(name, check_integrity)(); /* }}} */
