...
static int
apc_fcntl_call(int fd, int cmd, int type, off_t offset, int whence, off_t len)
{
    int ret;
    struct flock lock;
...
#else
PHP_APCU_API int
apc_lock_init(apc_lock_t* lock)
{
    lock->state = 0;
}

PHP_APCU_API int
apc_lock_try(apc_lock_t* lock)
{
    int failed = 1;

    asm volatile("xchgl %0, 0(%1)" : "=r"(failed) : "r"(&lock->state), "0"(failed));

    return failed;
}

PHP_APCU_API int
apc_lock_get(apc_lock_t* lock)
{
    int failed = 1;
...
PHP_APCU_API int
apc_lock_release(apc_lock_t* lock)
{
    int released = 0;

    asm volatile("xchg %0, 0(%1)" : "=r"(released) : "r"(&lock->state), "0"(released));
...
PHP_APCU_API zend_bool
apc_lock_create(apc_lock_t* lock)
{
#ifndef PHP_WIN32
#ifndef APC_SPIN_LOCK
#ifndef APC_FCNTL_LOCK
...
PHP_APCU_API zend_bool
apc_lock_rlock(apc_lock_t* lock)
{
#ifndef PHP_WIN32
#ifndef APC_SPIN_LOCK
#ifndef APC_FCNTL_LOCK
...
PHP_APCU_API zend_bool
apc_lock_wlock(apc_lock_t* lock)
{
#ifndef PHP_WIN32
#ifndef APC_SPIN_LOCK
#ifndef APC_FCNTL_LOCK
...
PHP_APCU_API zend_bool
apc_lock_wunlock(apc_lock_t* lock)
{
#ifndef PHP_WIN32
#ifndef APC_SPIN_LOCK
#ifndef APC_FCNTL_LOCK
...
PHP_APCU_API zend_bool
apc_lock_runlock(apc_lock_t* lock)
{
#ifndef PHP_WIN32
#ifndef APC_SPIN_LOCK
#ifndef APC_FCNTL_LOCK
...
PHP_APCU_API void
apc_lock_destroy(apc_lock_t* lock)
{
#ifndef PHP_WIN32
#ifndef APC_SPIN_LOCK
#ifndef APC_FCNTL_LOCK
