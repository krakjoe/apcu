...
apc_stack_t*
apc_stack_create(int size_hint)
{
...
void
apc_stack_destroy(apc_stack_t* stack)
{
    if (stack != NULL) {
...
void
apc_stack_clear(apc_stack_t* stack)
{
    assert(stack != NULL);
    stack->size = 0;
}
...
void
apc_stack_push(apc_stack_t* stack, void* item)
{
    assert(stack != NULL);
...
void*
apc_stack_pop(apc_stack_t* stack)
{
...
void*
apc_stack_top(apc_stack_t* stack)
{
    assert(stack != NULL && stack->size > 0);
...
void*
apc_stack_get(apc_stack_t* stack, int n)
{
...
int
apc_stack_size(apc_stack_t* stack)
{
    assert(stack != NULL);
    return stack->size;
}
