...
#define APC_ITER_KEY        (1L << 0)
#define APC_ITER_VALUE      (1L << 1)
#define APC_ITER_NUM_HITS   (1L << 2) 
#define APC_ITER_MTIME      (1L << 3) 
#define APC_ITER_CTIME      (1L << 4) 
#define APC_ITER_DTIME      (1L << 5) 
#define APC_ITER_ATIME      (1L << 6) 
#define APC_ITER_REFCOUNT   (1L << 7) 
#define APC_ITER_MEM_SIZE   (1L << 8) 
#define APC_ITER_TTL        (1L << 9)
